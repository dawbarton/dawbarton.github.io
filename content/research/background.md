...
* Numerical methods for dynamical systems (particularly bifurcation analysis)
* Systems with delay (delay differential equations)
* Scientific machine learning (Gaussian processes, deep learning, reinforcement learning)
