...
Academic life can progress in many different ways. As far as I can, I aim to provide a healthy work environment for all those I interact with. As such, I follow these principles taken from <https://ukrio.org/publications/code-of-practice-for-research/2-0-principles/> and I strongly encourage others to follow them. (Note: the UKRI principles have been updated several times to encompass other aspects, but below is a good summary.)
