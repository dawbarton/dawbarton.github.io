...
The projects below give a flavour of the kinds of research I supervise. They are intended as starting points for discussion rather than fixed plans &mdash; most are deliberately broad so there is plenty of room for you to shape your own direction. If you have a related idea that is not listed here, I am very happy to hear from you.

For funding and application information, see the [Work with me](../new-researchers/) page. To apply, email [david.barton@bristol.ac.uk](mailto:david.barton@bristol.ac.uk) with your CV and a short description of your research interests. **Applications from all backgrounds are encouraged, especially under-represented groups.**
...
&rarr; [Detailed project: hybrid modelling for aircraft design](/posts/2023/project-aeroelastic-experiments/)
...
Without our sense of touch, humans struggle with many manipulation tasks. The [TacTip](https://lepora.com/tactip/) tactile sensor gives robots this capability at low cost. Projects in this area explore generative online learning, allowing robots to learn sensor models in real time with very little prior data and extending these approaches to higher-dimensional tasks and a broader suite of robot actions.

&rarr; [Detailed project: online learning for tactile robotics](/posts/2023/project-online-learning-for-tactile-robotics/)
...
&rarr; [Detailed project: surrogate modelling for electrical power systems](/posts/2023/project-surrogate-modelling-electrical/)
...
&rarr; [Broad project areas overview](/posts/2021/broad-project-areas/)

---

See also the [current research team](../current-researchers/) and [previous team members](../previous-researchers/) to get a sense of the range of projects already underway.
